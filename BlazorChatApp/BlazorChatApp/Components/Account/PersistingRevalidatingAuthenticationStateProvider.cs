...
namespace BlazorChatApp.Components.Account
{
    ...
    internal sealed class PersistingRevalidatingAuthenticationStateProvider : RevalidatingServerAuthenticationStateProvider
    {
            ...
            AuthenticationState authenticationState, CancellationToken cancellationToken)
        {
            ...
            var userManager = scope.ServiceProvider.GetRequiredService<UserManager<US_User>>();
            return await ValidateSecurityStampAsync(userManager, authenticationState.User);
        }

        private async Task<bool> ValidateSecurityStampAsync(UserManager<US_User> userManager, ClaimsPrincipal principal)
        {
